...
{
    public partial class Expense_Voucher : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = "INSERT INTO [Expense_Database] (Date_,Vr_No,Company,Voucher_Type,Payee_or_From,On_Account_Of,Account_Code_1,Head_of_Account_1,Taka_1,Account_Code_2,Head_of_Account_2,Taka_2,Account_Code_3,Head_of_Account_3,Taka_3,Total,Prepared_By_or_Verified_By)values('" + DateTime.Today + "','" + textBox18.Text + "','" + label14.Text + "','" + label7.Text + "','" + txtbox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox13.Text + "','" + textBox11.Text + "','" + textBox9.Text + "','" + textBox14.Text + "','" + textBox12.Text + "','" + comboBox3.Text + "')";
