...
{
    public partial class Personal_Loan : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = "INSERT INTO [Personal_Loan_Database] (Date_,PLRF_No,Company,Voucher_Type,Name_,Designation_Dept,SL_No_1,Details_1,Amount_1,SL_No_2,Details_2,Amount_2,SL_No_3,Details_3,Amount_3,Total,Verified_By)values('" + DateTime.Today + "','" + textBox18.Text + "','" + label14.Text + "','" + label7.Text + "','" + txtbox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox13.Text + "','" + textBox11.Text + "','" + textBox9.Text + "','" + textBox14.Text + "','" + textBox12.Text + "','" + comboBox3.Text + "')";
