    ...
    public partial class O2B : Form
    {
        ...
        private void CaptureScreen()
        {
            ...
            string fileName = string.Format(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) +
                      @"\Contra_Voucher_Office_to_Bank" + "_" +
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                command.CommandText = "INSERT INTO [Con_Office_Bank_Database] (Date_,Vr_No,Company,Voucher_Type,Bank,Account_Details,SL_1,Details_1,Taka_1,SL_2,Details_2,Taka_2,SL_3,Details_3,Taka_3,Total,Prepared_By)values('" + DateTime.Today + "','" + textBox18.Text + "','" + label14.Text + "','" + label7.Text + "','" + txtbox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox7.Text + "','" + textBox8.Text + "','" + textBox13.Text + "','" + textBox11.Text + "','" + textBox9.Text + "','" + textBox14.Text + "','" + textBox12.Text + "','" + comboBox3.Text + "')";
